	...
	_createClass(App, [{
		...
		value: function render() {
			return _react2['default'].createElement(
				'div',
				null,
				_react2['default'].createElement(_NavbarJs2['default'], null),
...
},{"./Footer.js":7,"./Navbar.js":9,"react":"react","react-router":"react-router"}],7:[function(require,module,exports){
'use strict';
...
var _storesFooterStoreJs = require('../stores/FooterStore.js');

var _storesFooterStoreJs2 = _interopRequireDefault(_storesFooterStoreJs);

var _actionsFooterActionsJs = require('../actions/FooterActions.js');

var _actionsFooterActionsJs2 = _interopRequireDefault(_actionsFooterActionsJs);
...
var Footer = (function (_React$Component) {
  ...
  function Footer(props) {
    ...
    this.state = _storesFooterStoreJs2['default'].getState();
    this.onChange = this.onChange.bind(this);
  }
  ...
  _createClass(Footer, [{
    key: 'componentDidMount',
    value: function componentDidMount() {
      _storesFooterStoreJs2['default'].listen(this.onChange);
      _actionsFooterActionsJs2['default'].getTopCharacters();
    }
  }, {
    key: 'componentWillUnmount',
    value: function componentWillUnmount() {
      _storesFooterStoreJs2['default'].unlisten(this.onChange);
    }
  }, {
    key: 'onChange',
    value: function onChange(state) {
...
},{"../actions/FooterActions.js":2,"../stores/FooterStore.js":13,"react":"react","react-router":"react-router"}],8:[function(require,module,exports){
'use strict';
...
var _AddCharacter = require('./AddCharacter');
...
},{"./AddCharacter":5,"react":"react"}],9:[function(require,module,exports){
'use strict';
