...
class Footer extends React.Component {
	...
	render() {
		let leaderboardCharacters = this.state.characters.map((characters) => {
			return (
				<li key={character.characterId}>
					<link to={'/characters/' + character.characterId} >
						<img calssName = 'thumb-md' src={'http://image.eveonline.com/Character/',+ character.characterId + '_128.jpg'} />
					</link>
				</li>
			)
		})
